                    ...
                    <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-8 mt-4">
                        ...
                        <FormField control={form.control} name="webhookUrl" render={({field}) => (
                            <FormItem>
                                ...
                                <FormDescription>
                                    Get this from Discord: Channel Settings, then Integrations, then Webhooks
                                </FormDescription>
                                <FormMessage />
                            </FormItem>
                            )}
                        ...
                        <FormField control={form.control} name="content" render = {({field}) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Textarea placeholder="Summary: {{myGemini.text}}" className="min-h-[80px] font-mono text-sm" {...field} />
                                </FormControl>
                                <FormDescription>
